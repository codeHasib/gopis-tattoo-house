    ...
    <div className="min-h-screen bg-[#050505] text-white flex">
            ...
            <div className="flex flex-col items-center gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-zinc-500 text-[10px] uppercase tracking-[0.3em] mt-2 font-bold">
                  Securely logging out of Gopis Tattoo Studio
                </p>
              </div>
            </div>
          </motion.div>
      ...
      >
        ...
        >
          <Menu size={20} />
          {isOpen && (
            <span className="ml-4 text-sm font-medium">Collapse Menu</span>
          )}
        </button>
      </motion.aside>
      ...
      <div className="md:hidden fixed top-0 w-full bg-black/80 backdrop-blur-xl border-b border-zinc-800 p-4 z-[60] flex justify-between items-center px-6">
        <div className="flex items-center gap-3">
          ...
          <span className="font-bold tracking-tighter uppercase text-xs">
            Gopis Tattoo Studio
          </span>
        </div>
        <button
      ...
      <AnimatePresence>
        {isMobileOpen && (
          <>
            ...
            >
              <div className="mb-10 text-xl font-bold tracking-tighter italic uppercase text-white">
                Navigation
              </div>
      ...
      <main
        className={`flex-1 flex flex-col min-w-0 transition-all duration-500 ${isLoggingOut ? "blur-sm grayscale opacity-50" : ""}`}
      >
