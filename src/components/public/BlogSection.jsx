...
export default async function BlogSection() {
  ...
  return (
    <section className="bg-black py-24 px-6 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 opacity-[0.02] pointer-events-none select-none z-0"></div>
            ...
            return (
              ...
              >
                ...
                <div className="absolute inset-0 z-10 p-10 flex flex-col justify-between">
                  ...
                  <div>
                    <h3
                      className={`font-black uppercase tracking-tighter text-white leading-tight mb-4 ${
